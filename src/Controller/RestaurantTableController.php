...
final class RestaurantTableController extends AbstractController
{
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$restaurantTable->getId(), $request->getPayload()->getString('_token'))) {
